...
def create_sample_students():
    first_names = ["Іван тест", "Олена тест", "Петро тест", "Марія тест", "Олексій тест", 
                    "Анна тест", "Андрій тест", "Наталія тест", "Сергій тест", "Юлія тест", 
                    "Дмитро тест", "Тетяна тест", "Михайло тест", "Катерина тест"]
